...
export default function LandingPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen  bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900">
      <Appbar />
      <Redirect/>
      <main className="flex-1 justify-center items-center ml-32 py-12 md:py-24 lg:py-32">
      ...
      <section className="w-full py-12 md:py-24 pl-32 lg:py-32 bg-gray-800 bg-opacity-50">
      ...
      <section className="w-full py-12 pl-32 md:py-24 lg:py-32">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center space-y-4 text-center">
            <div className="space-y-2">
